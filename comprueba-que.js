(function (global, factory) {
    ...
    if(typeof global !== "undefined") {
        global.Comprueba = modulo;
    }
    if(typeof window !== "undefined") {
        window.Comprueba = modulo;
    }
})(this, (function () {
    ...
    class Comprueba {
        ...
        no_es_igual_que(value, valueID = undefined) {
            if (this.objetivo !== value) {
                return this;
            }
            throw new Error("Comprueba que «" + this.identificador + "» no es igual que «" + (valueID || value) + "» [error: " + this.identificador_de_error + "]");
        }
        ...
        no_es_booleano() {
            ...
            throw new Error("Comprueba que «" + this.identificador + "» no es un booleano [error: " + this.identificador_de_error + "]");
        }
        ...
        no_es_numero() {
            ...
            throw new Error("Comprueba que «" + this.identificador + "» no es un número [error: " + this.identificador_de_error + "]");
        }
        ...
        no_es_texto() {
            ...
            throw new Error("Comprueba que «" + this.identificador + "» no es un texto [error: " + this.identificador_de_error + "]");
        }
        ...
        no_es_objeto() {
            ...
            throw new Error("Comprueba que «" + this.identificador + "» no es un objeto [error: " + this.identificador_de_error + "]");
        }
        ...
        no_es_funcion() {
            ...
            throw new Error("Comprueba que «" + this.identificador + "» no es una función [error: " + this.identificador_de_error + "]");
        }
        ...
        no_es_lista() {
            ...
            throw new Error("Comprueba que «" + this.identificador + "» no es una lista [error: " + this.identificador_de_error + "]");
        }
        ...
        no_es_instancia_de(someClass, someClassID = false) {
            try {
                if (!(this.objetivo instanceof someClass)) {
                    return this;
                }
